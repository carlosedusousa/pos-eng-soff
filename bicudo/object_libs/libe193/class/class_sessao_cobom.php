...
class Sessao {
    ...
    function perm_login ($strperfil,$strrotina) {
        ...
        $sql = "SELECT ch_consultar,ch_inserir,ch_alterar,ch_excluir FROM ".TBL_PERFILAMENTO_ACESSO." WHERE id_rotina = '$strrotina' AND id_perfil='$strperfil'";
        //echo "<!--aqui per:$sql-->\n";
    ...
    function get_id_by_login ($str_login,$str_pass) {
        ...
        $sql = "SELECT id_matricula,nm_login,id_perfil FROM ".TBL_EFETIVO." WHERE nm_login = '$str_login'";
        ...
        if ($this->bd->query($sql)) {
            ...
            if ($this->bd->num_rows()) {
              ...
              $this->err_msg_ses= 'Usuário não encontrado na Base do COBOM !!!';
            }
        }
        return false;
    }
