...
function http_redir ($destino) {
    // Não faz nada se o cabecalho HTTP já foi enviado.
    if (headers_sent())
        return false;
    ...
    // Pára o script para nao mostrar mais nada.
    die ();
}
...
<body>
<h2><<< A Execução foi interrompida!!! >>></h2>
...
<p><a href=\"".PAGINA_ROOT."\">Voltar à Página Inicial do SIGAT</a></p>
</body>
</html>
");
}
