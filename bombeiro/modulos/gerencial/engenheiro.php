...
?>
      <script language="javascript" type="text/javascript">//<!--
        window.opener.document.frm_vist_habitese.hdn_id_crea_<?=trim($_GET["hdn_campo"])?>.value="<?=$ID_CREA?>";
        window.opener.document.frm_vist_habitese.txt_nm_engenheiro_<?=trim($_GET["hdn_campo"])?>.value="<?=$_GET["txt_nm_engenheiro"]?>";
        window.close();
      //--></script>
<?
  }
