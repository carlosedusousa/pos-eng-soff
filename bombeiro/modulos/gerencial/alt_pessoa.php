...
if (window.confirm("Pagamente Pendente, Deseja Pagar?")) {
    window.open("../analise/ranalise.php?txt_id_analise=<?=$ID_ANALISE?>&txt_id_cidade=<?=$ID_CIDADE?>","window_pgto","top=0,left=0,screenY=0,screenX=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=780,height=500,innerwidth=780,innerheight=500");
  } else {
    if (window.confirm("Deseja Imprimir Análise!")) {
      window.open("../analise/ranalise.php?txt_id_analise=<?=$ID_ANALISE?>&txt_id_cidade=<?=$ID_CIDADE?>","relanalise","top=5000,left=5000,screenY=5000,screenX=5000,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=no,resizable=no,width=1,height=1,innerwidth=1,innerheight=1");
    }
  }
<?
  } else {
...
?>
 <script language="javascript" type="text/javascript">//<!--
    ...
    function envia(edificacao) {
      ...
      window.open("../edificacoes/edificacao_p.php?hdn_id_solicitacao="+frm_ed.hdn_id_solicitacao.value+"&hdn_id_cidade="+frm_ed.hdn_id_cidade.value+"&hdn_id_tipo_solicitacao="+frm_ed.hdn_id_tipo_solicitacao.value+"&hdn_id_edificacao="+edificacao+"&alt=1","cad_ed","top=0,left=0,screenY=0,screenX=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=780,height=500,innerwidth=780,innerheight=500")
    }
    function envia_cons_ed() {
      var frm_ed = document.frm_analise;
      window.open("../edificacoes/consulta_edificacao.php?hdn_id_cidade="+frm_ed.hdn_id_cidade.value,"cons_ed","top=0,left=0,screenY=0,screenX=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=780,height=500,innerwidth=780,innerheight=500")
    }
//--></script>
...
<!--                           <input type="hidden" name="hdn_id_edificacao" value=""> -->
                          ...
                          <input type="text" name="txt_id_protocolo" class="campo_obr" size="15" maxlength="11" value="" title="Número do Protocolo" onblur="consultaReg(document.frm_analise.hdn_id_cidade,this,'analise_cons.php')">
                        </td>
                      </tr>
                      <tr>
                        <td colspan="4">
                        ...
                        <fieldset>
                          ...
                          <table width="100%" cellspacing="0" border="0" cellpadding="2" align="center">
                            ...
                            <tr>
                              ...
                              <input name="btn_edificacao" type="button" value="Edificação" class="botao" style="background-image : url('../../imagens/botao.gif');" onClick="envia_cons_ed()">
                              </td>
                            </tr>
                          </table>
                        </fieldset>
