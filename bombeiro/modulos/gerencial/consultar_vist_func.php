<?  //echo "<pre>"; print_r($_GET); print_r($_POST); echo "</pre>";
    ...
    // Procurar por salas cadastradas
        $sql = "select 
            ID_CIDADE, 
            ID_SOLIC_FUNC, 
            ID_TP_FUNC,
        ...
        if (!$rs2) {
            ...
            $conn->query($sql);
            //echo "<pre>conn: "; print_r($conn); echo "</pre>";
            while ($r = $conn->fetch_row()) $rs3[] = $r;
            //echo "<pre>rs3: "; print_r($rs3); echo "</pre>";
            $CH_TP_FUNC = 'T';
...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        f.hdn_id_solic_func.value = '<?=$ID_SOLIC_FUNC?>';
        ...
        f.txt_nm_fantasia.value = '<?=$NM_FANTASIA?>';
        ...
        if (f.cmb_ch_tp_funcionamento.value == "P") {
            ...
            <? foreach ($rs2 as $i=>$v) { ?>
                ...
                f.hdn_nm_desc_funcionamento.value+='<?=$v['NM_DESC_FUNC']?>'+"^"; // f.txt_nm_desc_funcionamento_tmp.value
            ...
            sec_cmb_desc_funcionamento = f.cmb_desc_funcionamento.options.length++;
            f.cmb_desc_funcionamento.options[sec_cmb_desc_funcionamento].text = " - - - - - - - - - - - - ";
            f.cmb_desc_funcionamento.options[sec_cmb_desc_funcionamento].value = "";
            ...
            f.btn_incluir_desc.style.backgroundImage="url('../../imagens/botao2.gif')";
            f.btn_incluir_desc.disabled=true;
            f.btn_excluir_desc.disabled=false;
            f.btn_excluir_desc.style.backgroundImage="url('../../imagens/botao2.gif')";
