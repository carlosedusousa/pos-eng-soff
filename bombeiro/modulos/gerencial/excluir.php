			...
			Protocolo <input type="text" name="txt_id_solicitacao" class="campo_obr" size="15" maxlength="11" value="">
                      ...
                      <tr>
                        ...
                        <fieldset>
                          ...
                          <table width="100%" cellspacing="0" border="0" cellpadding="2" align="center">
                            <tr>
                              <td align="right" nowrap="true">Registro da Edificação</td>
                              <td>
                              ...
                              <td align="right">Nome</td>
                              <td colspan="3"><input type="text" disabled="disabled" name="txt_nm_edificacao" size="65" class="campoDesabilitado" title="Nome da Edificação" value="" readOnly="true"></td>
                            </tr>
                            <tr>
                              <td align="right">Área Construida</td>
                              <td>
                              <input type="text" align="right" disabled="disabled" name="txt_vl_area_construida" class="campoDesabilitado" size="18" title="Valor da Área Total Construida da Edificação" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,2)" readOnly="true"><em>(m²)</em>
                              </td>
                              <td colspan="2">&nbsp;</td>
                            </tr>
                          </table>
   		    ...
   		    <tr>
		    <td>
		      <fieldset><legend>Dados da exclusão</legend>
