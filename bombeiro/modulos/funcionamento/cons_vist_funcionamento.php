...
//    	TBL_SOL_FUNC.".ID_SOLIC_FUNC, ".
	...
	FROM ".TBL_VISTORIA_FUNC." " .
		...
		"LEFT JOIN ".TBL_PESSOA." ON (".
			TBL_VISTORIA_FUNC.".ID_CNPJ_EMPRESA=".TBL_PESSOA.".ID_CNPJ_CPF AND ".
			TBL_VISTORIA_FUNC.".ID_CIDADE_EMPRESA=".TBL_PESSOA.".ID_CIDADE) " .
		...
		"LEFT JOIN ".TBL_SOL_FUNC." ON(".
 		...
 		"LEFT JOIN ".TBL_CIDADE." ON(".
	 		TBL_SOL_FUNC.".ID_CIDADE=".TBL_CIDADE.".ID_CIDADE) " .
		...
		"WHERE ".
			TBL_PROT_FUNC.".ID_CIDADE=".$ID_CIDADE." AND ".
			TBL_PROT_FUNC.".ID_PROT_FUNC=".$ID_PROT_FUNC;
// echo "aqui $query";exit;
    $conn->query($query);
    ...
    if ($row_solicita>0) {
      ...
      while ($registro = $conn->fetch_row()) $solicitacao = $registro;

// echo "<pre>"; print_r($solicitacao); echo "</pre>"; exit;
