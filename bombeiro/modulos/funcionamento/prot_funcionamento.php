<?
  ...
  'txt_nm_empresa'=>"'txt_nm_empresa,Razão Social,t'",
  ...
  'txt_vl_area_vistoria'=>"'txt_vl_area_vistoria,Valor da Área a ser Vistoriada,t'",
  'cmb_id_servico'=>"'cmb_id_servico,Serviço Prestado,n'",
  'cmb_id_tp_servico'=>"'cmb_id_tp_servico,Tipo de Serviço,n'"
  );
  ...
  if (($ID_LOGRADOURO!="NULL")&&($ID_CEP!="NULL")) {
	...
	if(!$encontrouSolicitacao || @$_POST[btn_enviar_solicitacao]) {
	  ...
	  if ($global_inclusao=='S') {
	    ...
	    if ($conn->get_status()==false) {
	      $ERRO_TRANS.="ERRO NA SELEÇÃO DO SERVIÇO: ".$conn->get_msg()."\n";
	      $query_trans="ROLLBACK";
	    }
	    ...
	    if ($RESULTADO>0) {
	      ...
	      for ($NR_PARCELA=1;$NR_PARCELA<=$fetch_formula["NR_MAX_PARCELA"];$NR_PARCELA++) {
	        ...
	        if ($conn->get_status()==false) {
	          $ERRO_TRANS.="ERRO NA CRIAÇÃO DO BOLETO: ".$conn->get_msg()."\n";
	          $query_trans="ROLLBACK";
	        }
	      }
	    }
	    ...
	    if ($conn->get_status()==false) {
	      $ERRO_TRANS.="ERRO NTRANSAÇÃO:".$conn->get_msg()."\n";
	      $query_trans="ROLLBACK";
...
window.confirm("Solicitação Protocolada com o número <?=$ID_PROT_FUNC?>")
      ...
      <td colspan="2" rowspan="1" style="vertical-align: top;">
        <fieldset>
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="2">
                            <tr>
                              <td>CNPJ</td>
                              <td><input type="text" name="txt_nr_cnpj_empresa" value="<?=$_POST['txt_nr_cnpj_empresa']?>" size="20" maxlength="18" class="campo_obr" title="CPF ou CNPJ da Empresa Solicitante de Funcionamento da Edificação" onblur="cpfcnpj(this)" value=""></td>
                              <td>Razão Social</td>
                              <td><input type="text" name="txt_nm_empresa" value="<?=$_POST['txt_nm_empresa']?>" size="50" maxlength="100" class="campo_obr" title="Razão Social da Empresa Solicitante do Funcionamento"></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="2">
                            <tr>
                              ...
                              <td>Nome Contato</td>
                              <td><input type="text" name="txt_nm_contato" value="<?=$_POST['txt_nm_contato']?>" size="30" maxlength="100" class="campo_obr" title="Nome do Responsável da Empresa Solicitante"></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
			  ...
			  <table width="100%" border="0" cellpadding="2" cellspacing="2">
                            <tr>
                              <td width="30">Fone</td>
                              <td><input type="text" name="txt_nr_fone_empresa" value="<?=$_POST['txt_nr_fone_empresa']?>" size="13" maxlength="12" class="campo_obr" title="Fone do Solicitante de Funcionamento da Edificação"></td>
                              <td>E-mail</td>
                              <td><input type="text" name="txt_de_email_empresa" value="<?=$_POST['txt_de_email_empresa']?>" size="61" maxlength="100" class="campo_obr" title="E-mail do Solicitante de Funcionamento da Edificação" style="text-transform : none;"></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
	...
	<legend>Protocolo</legend>
	  ...
	  <tr>
	    ...
	    <td>
	      ...
	      <input type="text" name="txt_id_prot_funcionamento" value="" class="campo" align="right" title="Número do Protocolo" size="15" maxlength="11" onblur="consultaReg(this,'cons_prot_funcionamento.php')">
	    </td>
...
?>
	  ...
	  <tr>
	    <td>
		  ...
		  <td>
		    <input type="text" name="txt_nr_cnpj_empresa" size="35" maxlength="18" class="campo_obr" title="CPF ou CNPJ da Empresa Solicitante de Funcionamento da Edificação" onblur="cpfcnpj(this)" value="">
		  </td>
                <td nowrap="true" align="right">Razão Social</td>
                 <td>
		    <input type="text" name="txt_nm_empresa" size="60" maxlength="100" class="campo_obr" title="Razão Social da Empresa Solicitante do Funcionamento">
		 </td>
            </tr>
              <tr>
		<td align="right" nowrap="true">Nome Fantasia Empresa</td>
		 ...
		 <td>
		   <input type="text" name="txt_nm_contato" size="60" maxlength="100" class="campo_obr" title="Nome do Responsável da Empresa Solicitante">
		 </td>
              </tr>
		<tr>
		  <td  align="right" width="30">Fone</td>
		  <td><input type="text" name="txt_nr_fone_empresa" size="35" maxlength="12" class="campo_obr" title="Fone do Solicitante de Funcionamento da Edificação"></td>
		  <td align="right">E-mail</td>
		  <td><input type="text" name="txt_de_email_empresa" size="60" maxlength="100" class="campo_obr" title="E-mail do Solicitante de Funcionamento da Edificação" style="text-transform : none;"></td>
		</tr>
	      </table>
	    </td>
	  </tr>
  ...
  <tr>
	...
	<legend>Edificação</legend>
	  ...
	  <tr>
	    ...
	    <td colspan="3"><input type="text" name="txt_nm_edificacao" size="58" class="campo_obr" title="Nome da Edificação" value="" readOnly="true"></td>
	  </tr>
	    <tr>
...
?>
	  ...
	  <tr>
	    ...
	    <td height="10"><input type="text" size="21" maxlength="5" name="txt_nr_edificacao" align="right" class="campo" title="Número da Edificação no Logradouro" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,0)" readOnly="true"></td>
	  ...
	  <tr>
	    <td align="right">CEP</td>
	    <td><input type="text" size="25" maxlength="10" name="txt_id_cep" value="" class="campo_obr" title="Número do CEP" onkeypress="return validaTecla(this, event, 'n')" onblur="CEP(this)" readOnly="true"></td>
	    ...
	    <tr>
	      ...
	      <td colspan="2"><input type="text" name="txt_nm_complemento" class="campo" size="50" maxlength="100" value="" title="Complemento do Endereço da Edificação" readOnly="true"></td>
	      <td>
	    ...
	    <tr>
	      <td align="right">Área Construida</td>
	      <td><input type="text" align="right" name="txt_vl_area_tot_const" size="25" class="campo_obr" title="Valor da Área Total Construida da Edificação" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,2);verifica_valor();" readOnly="true"></td>
	      <td align="right">Área de Vistoria</td>
	      <td>
		<input type="text" align="right" name="txt_vl_area_vistoria" size="25" class="campo_obr" title="Valor da Área a ser Vistoriada" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,2);verifica_valor();">
	      </td>
	    </tr>
	</table>
      </fieldset>
	...
	<legend align="left">Financeiro</legend>
	  ...
	  <tr>
	    ...
	    <td>
	      ...
	      <select name="cmb_id_servico" class="campo_obr" title="Serviço a Ser Prestado" onChange="consultaSelc(this.form.name,'cmb_id_tp_servico','<?=TBL_TP_SERVICO?>','ID_TP_SERVICO,NM_TP_SERVICO','ID_SERVICO='+this.value+' AND ID_CIDADE='+document.frm_prot_funcionamento.hdn_id_cidade.value,'s',this,'cmb_id_tp_servico','');">
		<option value="">____________________</option>
	      </select>
	    </td>
	    <td align="right">Tipo Serviço</td>
	    <td>
