                        ...
                        <fieldset>
                          ...
                          <table width="100%" cellspacing="2" border="0" cellpadding="2">
                            <tr>
                              ...
                              <td><input type="text" name="txt_id_edificacao" size="20" class="campo_obr" title="RE da Edificação" value="" maxlength="15" align="right" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,0)"></td>
                              <td align="right">Nome</td>
                              <td><input type="text" name="txt_nm_edificacao" size="61" class="campo_obr" title="Nome da Edificação" value="" readOnly="true"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="right">N°</td>
                              <td><input type="text" size="20" maxlength="5" name="txt_nr_edificacao" align="right" class="campo_obr" title="Número da Edificação no Logradouro" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,0)" readOnly="true"></td>
                            ...
                            <tr>
                              ...
                              <td><input type="text" size="20" maxlength="10" name="txt_id_cep" value="" class="campo_obr" title="Número do CEP" onkeypress="return validaTecla(this, event, 'n')" onblur="CEP(this)" readOnly="true"></td>
                            ...
                            <tr>
                              ...
                              <td><input type="text" name="txt_nm_complemento" class="campo" size="30" maxlength="100" value="" title="Complemento do Endereço da Edificação" readOnly="true"></td>
                              <td colspan="2">
                                <center>
                             ...
                             <tr>
                              ...
                              <td>
                              <input type="text" align="right" name="txt_vl_area_construida" class="campo_obr" title="Valor da Área Total Construida da Edificação" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,2)" readOnly="true" value="" size="20"><em>(m²)</em>
                              </td>
                              <td align="right" nowrap="true">Área Vistoriada</td>
                              <td colspan="3">
