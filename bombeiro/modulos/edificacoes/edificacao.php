...
<script language="javascript" type="text/javascript">//<!--
    ...
    function cons_logra(valor,cidade,nr) {
	      window.open("./modulos/edificacoes/cons_logra_func_ed.php?txt_nm_logradouro="+valor+"&hdn_id_cidade="+cidade+"&txt_nr_edificacao="+nr,"cons_logradouro","top=0,left=0,screenY=0,screenX=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=780,height=670,innerwidth=780,innerheight=670")
    }
    function cad_log() {
      ...
      if ((cep!="")&&(cidade!="")) {
        ...
        ?>
        window.open("../edificacoes/cad_lograd_ed.php?txt_id_cep="+cep+"&hdn_id_cidade="+cidade+"&txt_nm_cidade="+nomecidade,"cad_cons_logradouro","top=0,left=0,screenY=0,screenX=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=800,height=550,innerwidth=800,innerheight=550");
      } else {
    ...
    function envia_cons_ed() {
      ...
      window.open("./modulos/edificacoes/consulta_edif.php?hdn_id_cidade="+frm_ed.hdn_id_cidade.value+"&form_padrao=frm_edificacao","cons_ed","top=0,left=0,screenY=0,screenX=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=780,height=500,innerwidth=780,innerheight=500")
    }
    function envia_cons_pro() {
      var frm_ed = document.frm_edificacao;
      window.open("./modulos/edificacoes/consulta_propr.php?form_padrao=frm_edificacao&txt_nm_pessoa="+document.frm_edificacao.txt_nm_proprietario.value,"cons_ed","top=0,left=0,screenY=0,screenX=0,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=no,width=780,height=500,innerwidth=780,innerheight=500")
    }
</script>
...
<input type="hidden" name="hdn_form_padrao" value="<?=$form_padrao?>">
	...
	<tr>
	  <td >
	    <fieldset>
	    <legend>Registro da Edifica&ccedil;&atilde;o</legend>
		<table width="100%" cellspacing="2" border="0" cellpadding="2">
		<tr>
		  <td align="left" nowrap="true">Cidade
		  <? if ($form_padrao=="") { ?>
		  <script language="javascript" type="text/javascript">document.frm_edificacao.txt_id_edificacao.readOnly=false;</script>
		    <select name="cmb_id_cidade" class="campo_obr" title="Nome da Cidade onde está localizada a Edifica&ccedil;&atilde;o" onChange="javascript:document.frm_edificacao.hdn_id_cidade.value=this.value;consultaReg(document.frm_edificacao.txt_id_edificacao,this,'./modulos/edificacoes/edificacao_cons.php');">
		...
		RE <input type="text" name="txt_id_edificacao" class="campo" value="" readOnly="false" onkeypress="return validaTecla(this, event, 'n')" title="Registro da Edifica&ccedil;&atilde;o" align="right" size="20" maxlength="15" onchange="consultaReg(this,document.frm_edificacao.cmb_id_cidade,'./modulos/edificacoes/edificacao_cons.php')">
		    </td>
			<td>
			    Seleciode uma RE existente para alterar <br> ou inclua uma nova cadastrando as informações abaixo.
			</td>
		    </tr>     
		</table>
	    </fieldset>      
	    ...
	    <td >
		  ...
		  <table width="100%" cellspacing="2" border="0" cellpadding="2">
			...
			<td align="right" nowrap="true">CNPJ/CPF</td>
			  <td><input type="text" name="txt_nr_cnpjcpf_proprietario" size="20" maxlength="18" class="campo_obr" title="CNPJ ou CPF do Propriet&aacute;rio da Edifica&ccedil;&atilde;o" onblur="cpfcnpj(this);consultaReg(this,'','./modulos/edificacoes/proprietario_cons.php');"></td>
			...
			<td>
			  <input type="button" name="btn_cons_proprietario" value="Propriet&aacute;rio" align="middle" title="Consulta Propriet&aacute;rio" class="botao"  onClick="envia_cons_pro()">
			</td>
		    </tr>
		    <tr>
			...
			<td align="right" nowrap="true">E-mail</td>
			  <td><input type="text" name="txt_de_email_proprietario" size="40" maxlength="100" class="campo_obr" title="E-mail do Prorietário da Edifica&ccedil;&atilde;o" style="text-transform : none;">
			</td>
		    </tr>
		  </table>
	      </fieldset>
	...
	<tr>
	  <td>
	    <table width="100%" cellspacing="2" border="0" cellpadding="2">
	      <tr>
		<td align="right" nowrap="true">RE</td>
		  <td><input type="text" name="txt_id_edificacao_old" class="campo2" value="" readOnly="true" onkeypress="return validaTecla(this, event, 'n')" title="Registro da Edifica&ccedil;&atilde;o" align="right" size="20" maxlength="15">
		<td align="right" nowrap="true">Nome</td>
	    ...
	    <table width="100%" cellspacing="2" border="0" cellpadding="2">
	      <tr>
		<td align="right" nowrap="true">Nome Fantasia 1</td>
		...
		<td align="right" nowrap="true">Nome Fantasia 2</td>
    ...
    <td>
	  ...
	  <table width="100%" cellspacing="2" border="0" cellpadding="2">
	      ...
	      <table width="100%" cellspacing="2" border="0" cellpadding="2">
	      <td align="right" nowrap="true">Nº</td>
	      <td>
		<input type="text" name="txt_nr_edificacao" size="5" maxlength="6" class="campo_obr" title="N&utilde;mero do Endere&ccedil;o da Edifica&ccedil;&atilde;o" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,0)" align="right">
	      </td>
		...
		<td>
		  <input type="button" name="btn_cons_edificacao" value="Consulta RE" align="middle	" title="Inclui o Registro" class="botao"  onClick="envia_cons_ed()">
		</td>
		<? } else { ?>
		...
		<td  align="right" nowrap="true">CEP
	      ...
	      <tr>
	    <td align="right" nowrap="true">Complemento</td>
	    <td>
		...
		<td colspan="2">
		  <center>
		    <input type="button" name="btn_valida_logradouro" value="Validar" class="botao"  title="Validar o Logradouro Existente" onClick="cons_logra(document.frm_edificacao.txt_nm_logradouro.value,document.frm_edificacao.hdn_id_cidade.value,document.frm_edificacao.txt_nr_edificacao.value)">
		  </center>
		</td>
	      </tr>
	  </table>
    ...
    <td>
	    ...
	    <table width="100%" cellspacing="2" border="0" cellpadding="2">
		<tr>
		<td align="right" nowrap="true">&Aacute;rea Total Constru&iacute;da</td>
		  <td>
	    ...
	    <td align="right" nowrap="true">Nº Pavimento</td>
	    <td>
...
?>
  ...
  alert("id cidade "<?$ID_CIDADE?>"/n id idificacao "<?=$ID_EDIFICACAO?>"/n nome cidade " <?=$NM_CIDADE?> );
