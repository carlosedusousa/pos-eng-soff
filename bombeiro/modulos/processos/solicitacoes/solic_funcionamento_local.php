...
?>
		...
		window.confirm("Solicitação enviada com sucesso!");
	    </script>
<?
            }
	...
	<fieldset>
	    ...
	    <form name="form_consultar_vist_func">
	      <table style="width: 100%; text-align: left;" border="0" cellpadding="2" cellspacing="2">
			...
			<td>
			    Seleciode um Protocolo existente para incluir como novo <br> ou inclua uma nova solicitação cadastrando as informações abaixo.
			</td>
        ...
        <fieldset>
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              size="70" maxlength="100" class="campo_obr" title="Nome do Solicitante de Análise da Edificação" 
            ...
            <tr>
              ...
              <td><input type="text" name="txt_de_email_empresa" value="<?=$_POST['txt_de_email_empresa']?>" size="70" maxlength="100" class="campo_obr" title="E-mail do Solicitante de Análise da Edificação" style="text-transform : none;"></td>
	      <td align="right" nowrap="true" >Fone</td>
              <td><input type="text" name="txt_nr_fone_empresa" value="<?=$_POST['txt_nr_fone_empresa']?>" size="30" maxlength="12" class="campo_obr" title="Fone do Solicitante de Análise da Edificação"></td>
	    </tr>
          </table>
        </fieldset>
      </td>
              ...
              <td colspan="2">
               <table width="100%" border="0" cellpadding="2" cellspacing="2">
                    <? foreach($solicitacoes as $solicitacao) { ?>
                        ...
                        <tr>
                            <td align="right" nowrap="true" >Edificação:&nbsp;</td> 
        ...
        <fieldset>
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="2">
            <tr>
              ...
              <td><input type="text" name="txt_nm_solicitante" size="61" maxlength="100" class="campo_obr" title="Razão Social da Empresa Solicitante do Funcionamento" onblur="valida_prop()"></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="txt_nm_contato" size="61" maxlength="100" class="campo_obr" title="Nome do Responsável da Empresa Solicitante"></td>
            </tr>
            <tr>
              <td align="right">Fone</td>
              <td><input type="text" name="txt_nr_fone_empresa" size="30" maxlength="12" class="campo_obr" title="Fone do Solicitante de Funcionamento da Edificação"></td>
        ...
        <fieldset>
          <legend>Proprietário da Edificação</legend>
		   ...
		   <input type="text" name="txt_nr_cnpjcpf_proprietario" size="30" maxlength="18" class="campo_obr"  onblur="cpfcnpj(this);valida_prop();consultar_vist_func();" value="">
                ...
                <td><input type="text" name="txt_nm_proprietario" size="75" maxlength="100" class="campo_obr" title="Nome do Proprietário da Edificação" onblur="valida_prop()">
		</td>
            </tr>
              <tr>
                <td align="right">Fone</td>
                <td><input type="text" name="txt_fone_proprietario" size="30" maxlength="12" class="campo_obr" title="Fone do Proprietário da Edificação"></td>
               <td align="right">E-mail</td>   
                <td><input type="text" name="txt_de_email_proprietario" size="75" maxlength="100" class="campo_obr" title="E-mail do Prorietário da Edificação" style="text-transform : none;"></td>
              </tr>
            </table>
        </fieldset>
      </td>
    ...
    <tr>
      <td colspan="2" rowspan="1" style="vertical-align: top;">
        <fieldset>
          ...
          <fieldset>
          <legend>Nome da Edificação</legend>
          <table width="100%" border="0" cellpadding="2" cellspacing="2">
            <tr>
              <td width="108" align="right">Nome</td>
              <td><input type="text" name="txt_nm_edificacao" size="50" maxlength="100" class="campo_obr" title="Nome da Edificação"></td>
              <td width="110" align="right" nowrap="true">Nome Fantasia</td>
              <td><input type="text" name="txt_nm_fantasia" size="50" maxlength="100" title="Nome Fantasia da Edifição" class="campo"></td>
            </tr>
          </table>
          </fieldset>
          <fieldset>
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="2">
            ...
            <tr>
              <td align="right">N°</td>
              <td>
                <input type="text" name="txt_nr_numero" size="21" maxlength="6" class="campo" title="Número do Endereço da Edificação" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,0)">
              </td>
              <td align="right">Bairro</td>
              <td><input type="text" name="txt_nm_bairro" size="61" maxlength="50" class="campo_obr" title="Bairro da Edificação"></td>
	      ...
	      <td align="right">Cidade</td>
             ...
             <td align="right">CEP</td>
              <td>
                <input type="text" name="txt_nr_cep" size="21" maxlength="40" class="campo" title="Número do CEP da Edificação" onkeypress="return validaTecla(this, event, 'n')" onblur="CEP(this)">
              </td>
             </tr>
             <tr>
              <td align="right">Complemento</td>
              <td><input type="text" name="txt_nm_complemento" size="28" maxlength="100" class="campo" title="Complemento do Endereço da Edificação"></td>
              <td align="right" nowrap="true">Área Total Construída</td>
              <td nowrap="true">
                <input type="text" name="txt_vl_area_tot_const" size="61" maxlength="17" align="right" class="campo_obr" title="Área total contruida da Edificação" onkeypress="return validaTecla(this, event, 'n')" onkeyup="FormatNumero(this)" onblur="decimal(this,2)">
                <em>(m²)</em>
              </td>
            </tr>
          </table>
	    ...
	    <table width="100%" border="0" cellpadding="2" cellspacing="2">
          ...
          <fieldset>
			...
			<input type="button" name="btn_excluir_desc" value="Excluir" class="botao"  disabled="true" onClick="exclui_desc()">
              ...
              <tr>
                      <td align="right">Área Total a Ser Vistoriada</td>
                      <td colspan="2">
