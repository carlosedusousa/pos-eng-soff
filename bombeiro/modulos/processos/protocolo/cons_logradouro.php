...
function consulta_ret(id_prefixo,id_logradouro,nm_logradouro,id_bairros,nm_bairros,id_cep,id_cidade,ch_aguardo) {
  var frm=window.opener.document.frm_protocolo;
  ...
  frm.txt_aguardo.value="Logradouro Válido";

  window.opener.servico(id_cidade)
...
<form method="GET" target="_self" name="form1" onsubmit="sbmit()">
	 	    ...
	 	    <table width="95%" cellspacing="0" border="2" cellpadding="0" align="center">
<head>
