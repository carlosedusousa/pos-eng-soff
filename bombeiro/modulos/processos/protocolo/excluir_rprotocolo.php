...
/*
    ...
    $ID_CIDADE=8045;
    */
    $ID_PROTOCOLO=@$_GET["txt_id_protocolo"];
    $ID_CIDADE=@$_GET["txt_id_cidade"];

//$ID_PROTOCOLO=5;
    $query="SELECT ID_PROTOCOLO, DATE_FORMAT(DT_SOLICITACAO,'%d/%m/%Y') DT_SOLICITACAO, ".TBL_USUARIO.".NM_USUARIO, NM_SOLICITANTE, CNPJ_CPF_SOLICITANTE, NR_FONE_SOLICITANTE, DE_EMAIL_SOLICITANTE, NM_EDIFICACOES_LX, NM_TP_LOGRADOURO,NM_LOGRADOURO, NR_EDIFICACOES_LX, NR_CEP, NM_CIDADE, NM_BAIRRO, NM_COMPLEMENTO, VL_AREA_CONTRUIDA, ".TBL_USUARIO.".ID_USUARIO FROM ".TBL_PROTOCOLOS." LEFT JOIN ".TBL_SOLICITACAO." ON (".TBL_PROTOCOLOS.".ID_SOLICITACAO=".TBL_SOLICITACAO.".ID_SOLICITACAO AND ".TBL_PROTOCOLOS.".ID_TIPO_SOLICITACAO=".TBL_SOLICITACAO.".ID_TIPO_SOLICITACAO AND ".TBL_PROTOCOLOS.".ID_CIDADE=".TBL_SOLICITACAO.".ID_CIDADE) LEFT JOIN ".TBL_TP_LOGRADOURO." ON (".TBL_SOLICITACAO.".ID_TP_LOGRADOURO=".TBL_TP_LOGRADOURO.".ID_TP_LOGRADOURO) LEFT JOIN ".TBL_CIDADE." ON (".TBL_SOLICITACAO.".ID_CIDADE=".TBL_CIDADE.".ID_CIDADE) LEFT JOIN ".TBL_USUARIO." ON (".TBL_PROTOCOLOS.".ID_USUARIO=".TBL_USUARIO.".ID_USUARIO) WHERE ".TBL_PROTOCOLOS.".ID_CIDADE=".$ID_CIDADE." AND ".TBL_PROTOCOLOS.".ID_PROTOCOLO=".$ID_PROTOCOLO;
   // echo "aqui ==>$query|\n";
...
//   $pdf->Cell(0,5,"CEP 88.015-600 - Fone 48 - 251-9600",0,0,'L',0);
  $pdf->ln();
  $pdf->SetX(20);
  $pdf->Cell(0,5,"PROTOCOLO DE PROJETO",0,0,'C',0);
...
$pdf->Image("../../imagens/brasaodocumento.jpg",5,10,15,15);
    ...
    */
    ...
    $pdf->SetFont('arial', 'B', 8);
    $pdf->Cell(30,5,$tupula["ID_PROTOCOLO"],0,0,'L',0);
    $pdf->SetFont('arial', '', 8);
    ...
    $pdf->Cell(30,5,"Solicitante",0,0,'L',1);
    $pdf->ln();
    $pdf->SetFont('arial', '', 8);
    ...
    $pdf->SetFont('arial', 'B', 8);
    $pdf->Cell(110,5,$tupula["DE_EMAIL_SOLICITANTE"],0,0,'L',0);
    $pdf->ln();
    $pdf->SetX(20);
    ...
    $pdf->SetFont('arial', 'B', 8);
   	$aux = explode ('-',$tupula["NM_LOGRADOURO"]);
	$pdf->Cell(90,5,$tupula["NM_TP_LOGRADOURO"].": ".$aux[0].$tupula["NR_EDIFICACAO"],0,0,'L',0);
    $pdf->SetFont('arial', '', 8);
